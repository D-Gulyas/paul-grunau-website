...
const TextReveal = React.memo(function TextReveal({
  ...
  // Nur funktionale Klassen – Typografie (Schriftart, Größe, Style) wird
  // bewusst vom umgebenden Element geerbt, damit das Design unverändert bleibt.
  ...
  return (
    <Component {...rootProps}>
      <span
        ...
        style={{ height: "1em", paddingLeft: "0.08em", paddingRight: "0.22em" }}
        aria-hidden="true"
      >
        {chars.map((char, i) => (
          <span
