...
/**
 * LogoLoop (React Bits) – Variante „JavaScript + CSS" nach Hersteller/logo_loop.md.
 * Übernommen wie vorgegeben: rAF-getriebener Endlos-Lauf, Breiten-Messung per
 * ResizeObserver, Kopien der Logo-Liste je nach Containerbreite.
 *
 * Nur ergänzt: "use client" (App Router) und der Wegfall des ungenutzten
 * `pauseOnHover`-Alias, damit keine tote Prop übrig bleibt.
 */
