      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pt-28 text-center">
        ...
        <div data-area="home-hero-headline" className="flex flex-col items-center">
          ...
          <BlurText
            ...
            as="h1"
            nowrap
            className="text-fett-kontur justify-center font-heading text-[clamp(1.2rem,6vw,5rem)] font-bold italic uppercase leading-[0.95] tracking-[-1px] text-[#e11d2a]"
          />
          {/* Zeile 2: untere Headline – proportional ~70 % von Zeile 1, damit sie nie größer wirkt */}
          <BlurText
            text="Meisterbetrieb Paul Grunau"
            delay={0.4}
            className="text-fett-kontur max-w-4xl justify-center font-heading text-[clamp(0.85rem,4.2vw,3.5rem)] font-bold italic uppercase leading-[0.95] tracking-[-1px] text-[#e11d2a]"
          />
        </div>
