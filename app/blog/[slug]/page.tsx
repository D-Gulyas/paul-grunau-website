  ...
  return (
    <article data-area="blogartikel">
      {/* Header mit Titelbild.
          ...
          Bewusst wieder der ursprüngliche Aufbau: feste vh-Höhe + `object-cover`, Text darüber.
          Am 09.08.2026 lief hier ein Versuch, das Bild über seine eigene Höhe vollständig zu
          zeigen (kein `object-cover`, ab `md` gestapelt) – auf Wunsch des Kunden zurückgedreht,
          die Optik gefiel nicht. Der Beschnitt auf dem Desktop ist damit gewollt und **kein**
          offener Fehler. Wer es erneut angeht: die Notizen zum Versuch stehen in
          `04 Regeln und Fallstricke` im Projektgehirn. */}
